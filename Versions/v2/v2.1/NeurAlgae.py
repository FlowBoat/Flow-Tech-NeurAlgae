...
layer1_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(inputs_0)
drop1_0 = Dropout(0.005)(layer1_0)
layer2_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop1_0)
drop2_0 = Dropout(0.005)(layer2_0)
layer3_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop2_0)
drop3_0 = Dropout(0.005)(layer3_0)
layer4_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop3_0)
drop4_0 = Dropout(0.005)(layer4_0)
layer5_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop4_0)
drop5_0 = Dropout(0.005)(layer5_0)
layer6_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop5_0)
drop6_0 = Dropout(0.005)(layer6_0)
layer7_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop6_0)
drop7_0 = Dropout(0.005)(layer7_0)
layer8_0 = Dense(128, activation = "relu", activity_regularizer = regularizers.l2(0.00001))(drop7_0)
drop8_0 = Dropout(0.005)(layer8_0)
...
PN_0h = netPN_0.fit(x = X_0, y = PN_0, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
CDA_0h = netCDA_0.fit(x = X_0, y = CDA_0, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PDA_0h = netPDA_0.fit(x = X_0, y = PDA_0, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PN_15h = netPN_15.fit(x = X_15, y = PN_15, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
CDA_15h = netCDA_15.fit(x = X_15, y = CDA_15, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PDA_15h = netPDA_15.fit(x = X_15, y = PDA_15, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PN_1h = netPN_1.fit(x = X_1, y = PN_1, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
CDA_1h = netCDA_1.fit(x = X_1, y = CDA_1, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PDA_1h = netPDA_1.fit(x = X_1, y = PDA_1, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PN_3h = netPN_3.fit(x = X_3, y = PN_3, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
CDA_3h = netCDA_3.fit(x = X_3, y = CDA_3, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PDA_3h = netPDA_3.fit(x = X_3, y = PDA_3, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PN_7h = netPN_7.fit(x = X_7, y = PN_7, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
CDA_7h = netCDA_7.fit(x = X_7, y = CDA_7, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
...
PDA_7h = netPDA_7.fit(x = X_7, y = PDA_7, batch_size = 32, epochs = 64, verbose = 1, validation_split = 0.2, shuffle = True)
